...
Module Bdd
    Public BddHost As String = "localhost"
    Public BddUser As String = "root"
    Public BddPass As String = ""
    Public BddNom As String = "bddcimebast"
    ...
    Function GetDataTable(commande As String) As DataTable
        ...
        strConnString = "Server=" & BddHost & ";User Id=" & BddUser & "; Password=" & BddPass & "; Database=" & BddNom & "; Pooling=false"
